...
class TestAppTestUITests: XCTestCase {
    ...
    func test5Main() {
        ...
        if app.frame.size.width == 375 { //iPhone Normal (6, 7, ...)
            ...
            coordRaids = normalized.withOffset(CGVector(dx: 597, dy: 269))
            ...
            coordRaids = normalized.withOffset(CGVector(dx: 1224, dy: 413))
            ...
            coordRaids = normalized.withOffset(CGVector(dx: 509, dy: 230))
